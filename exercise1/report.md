# Μέθοδοι Στατιστικής και Μηχανικής Μάθησης
...
**Φοιτητής:**  
Σωκράτης Βησσαρίων Γιαννούτσος  
**Α.Μ.:** 3220028
...
4.  **Κλιμάκωση (Scaling)**:Χρησιμοποιήθηκε η ενσωματωμένη συνάρτηση scale() της R, η οποία εφαρμόζει τυποποίηση με βάση τον sample τύπο (n−1). Η διαδικασία ήταν απαραίτητη ώστε όλες οι μεταβλητές να βρίσκονται στην ίδια κλίμακα, επιτρέποντας πιο αξιόπιστο υπολογισμό αποστάσεων και σαφέστερη διαμόρφωση clusters.
...
Το γράφημα επιτρέπει την **οπτική σύγκριση των clusters ως προς τις βασικές μεταβλητές** (lead_time, average_price, persons, nights, car_parking, special_requests και market_segment) και συμβάλλει στην ερμηνεία των προφίλ κάθε ομάδας. Επίσης βοήθησε και στην επιλογή των χαρακτηριστικών για την ομαδοποίηση, καθώς είδαμε που διαφέρουν τα clusters.
